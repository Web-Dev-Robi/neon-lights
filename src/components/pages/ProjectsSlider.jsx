				...
				<div className={styles.row}>
					...
					<div className={`${styles.column} ${styles.greenparty}`}>
						<div className={styles.content}>
							...
							<p className={styles.para}>
								Lorem ipsum dolor sit amet, tempor prodesset eos
								no. Temporibus necessitatibus sea ei, at tantas
								oporteat nam. Lorem ipsum dolor sit amet, tempor
								prodesset eos no.
							</p>
						</div>
					</div>
